...
import com.drewapps.ai.databinding.ActivityChecklistAdCopyBinding;
...
public class ChecklistAdCopyActivity extends AppCompatActivity {

    ActivityChecklistAdCopyBinding binding;
    Template template;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityChecklistAdCopyBinding.inflate(getLayoutInflater());
    ...
    private void initUI() {
        ...
        binding.etLanguage.setOnClickListener(v -> {
            Tools.ShowPopUpMenu(ChecklistAdCopyActivity.this, v, binding.etLanguage,
        ...
        binding.btnGenerate.setOnClickListener(v -> {
            ...
            binding.tilOccasion.setErrorEnabled(false);
            if (validate()) {
        ...
        binding.etOccasion.setOnClickListener(v->{
            binding.tilOccasion.setErrorEnabled(false);
        });
    }
    ...
    private void startGenerating() {
        ...
        String occasion = binding.etOccasion.getText().toString();
        ...
        executor.execute(() -> {
            ...
            try {
                ...
                Response<Document> response = ApiClient.getApiService().checklist_ad_copy(Config.API_KEY,
                        documentName, template.templateId, MyApplication.prefManager().getInt(Constants.USER_ID),
                        instruction, product_name, promotion, occasion,
                ...
                if (apiResponse.isSuccessful()) {
                    ...
                    runOnUiThread(() -> {
                        ...
                        dialogMsg.cancel();
                        Intent intent = new Intent(ChecklistAdCopyActivity.this, EditorActivity.class);
    ...
    private boolean validate() {
        if (binding.etDocumentName.getText().toString().isEmpty()) {
            ...
            return false;
        }else if (binding.etOccasion.getText().toString().isEmpty()) {
            binding.tilOccasion.setError("Occasion Name is required");
            binding.tilOccasion.setErrorEnabled(true);
            binding.etOccasion.requestFocus();
            return false;
