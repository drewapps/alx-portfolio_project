...
import com.drewapps.ai.databinding.ActivityAppSmsnotificationBinding;
...
public class AppSMSNotificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAppSmsnotificationBinding.inflate(getLayoutInflater());
    ...
    private void initUI() {
        ...
        binding.etOutput.setOnClickListener(v -> {
            Tools.ShowPopUpMenu(AppSMSNotificationActivity.this, v, binding.etOutput,
        ...
        binding.etLanguage.setOnClickListener(v -> {
            Tools.ShowPopUpMenu(AppSMSNotificationActivity.this, v, binding.etLanguage,
    ...
    private void startGenerating() {
        ...
        executor.execute(() -> {
            ...
            try {
                ...
                Response<Document> response = ApiClient.getApiService().app_sms_notification(Config.API_KEY,
                ...
                if (apiResponse.isSuccessful()) {
                    ...
                    runOnUiThread(() -> {
                        ...
                        dialogMsg.cancel();
                        Intent intent = new Intent(AppSMSNotificationActivity.this, EditorActivity.class);
