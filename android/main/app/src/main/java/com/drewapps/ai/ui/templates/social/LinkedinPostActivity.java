...
import com.drewapps.ai.databinding.ActivityLinkedinPostBinding;
...
public class LinkedinPostActivity extends AppCompatActivity {
    ...
    ActivityLinkedinPostBinding binding;
    Template template;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLinkedinPostBinding.inflate(getLayoutInflater());
    ...
    private void initUI() {
        ...
        binding.etOutput.setOnClickListener(v -> {
            Tools.ShowPopUpMenu(LinkedinPostActivity.this, v, binding.etOutput,
        ...
        binding.tiToneVoice.setEndIconOnClickListener(v -> {
            Tools.ShowPopUpMenu(LinkedinPostActivity.this, v, binding.etToneVoice,
        ...
        binding.etLanguage.setOnClickListener(v -> {
            Tools.ShowPopUpMenu(LinkedinPostActivity.this, v, binding.etLanguage,
    ...
    private void startGenerating() {
        ...
        executor.execute(() -> {
            ...
            try {
                ...
                Response<Document> response = ApiClient.getApiService().linkedin_post(Config.API_KEY,
                        documentName, template.templateId, MyApplication.prefManager().getInt(Constants.USER_ID),
                        instruction, output, voice, words,
                ...
                if (apiResponse.isSuccessful()) {
                    ...
                    runOnUiThread(() -> {
                        ...
                        dialogMsg.cancel();
                        Intent intent = new Intent(LinkedinPostActivity.this, EditorActivity.class);
    ...
    private boolean validate() {
        if (binding.etDocumentName.getText().toString().isEmpty()) {
            ...
            return false;
        } else if (binding.etWords.getText().toString().isEmpty() || Integer.parseInt(binding.etWords.getText().toString()) > 1000) {
