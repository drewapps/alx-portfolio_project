...
import com.drewapps.ai.databinding.ActivityInstagramHashtagsBinding;
...
public class InstagramHashtagsActivity extends AppCompatActivity {

    ActivityInstagramHashtagsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityInstagramHashtagsBinding.inflate(getLayoutInflater());
            ...
            try {
                ...
                if (apiResponse.isSuccessful()) {
                    ...
                    runOnUiThread(() -> {
                        ...
                        dialogMsg.cancel();
                        Intent intent = new Intent(InstagramHashtagsActivity.this, EditorActivity.class);
    ...
    private boolean validate() {
        if (binding.etDocumentName.getText().toString().isEmpty()) {
            ...
            binding.tilNoHashtag.setError("No of Hashtags is required");
            ...
            binding.tilNoHashtag.setError("Max 30 Hashtags");
            binding.tilNoHashtag.setErrorEnabled(true);
            binding.tilNoHashtag.requestFocus();
            return false;
        }
