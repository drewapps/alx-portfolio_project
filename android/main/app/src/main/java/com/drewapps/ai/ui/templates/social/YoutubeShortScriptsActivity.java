...
import com.drewapps.ai.databinding.ActivityYoutubeShortScriptsBinding;
...
public class YoutubeShortScriptsActivity extends AppCompatActivity {

    ActivityYoutubeShortScriptsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityYoutubeShortScriptsBinding.inflate(getLayoutInflater());
    ...
    private void initUI() {
        ...
        binding.etLanguage.setOnClickListener(v -> {
            Tools.ShowPopUpMenu(YoutubeShortScriptsActivity.this, v, binding.etLanguage,
    ...
    private void startGenerating() {
        ...
        executor.execute(() -> {
            ...
            try {
                ...
                Response<Document> response = ApiClient.getApiService().youtube_short_script(Config.API_KEY,
                ...
                if (apiResponse.isSuccessful()) {
                    ...
                    runOnUiThread(() -> {
                        ...
                        dialogMsg.cancel();
                        Intent intent = new Intent(YoutubeShortScriptsActivity.this, EditorActivity.class);
