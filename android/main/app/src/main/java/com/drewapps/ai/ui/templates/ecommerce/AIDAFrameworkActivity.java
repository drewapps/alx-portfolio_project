...
import com.drewapps.ai.databinding.ActivityAidaframeworkBinding;
...
public class AIDAFrameworkActivity extends AppCompatActivity {

    ActivityAidaframeworkBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAidaframeworkBinding.inflate(getLayoutInflater());
    ...
    private void initUI() {
        ...
        binding.etLanguage.setOnClickListener(v -> {
            Tools.ShowPopUpMenu(AIDAFrameworkActivity.this, v, binding.etLanguage,
    ...
    private void startGenerating() {
        ...
        executor.execute(() -> {
            ...
            try {
                ...
                Response<Document> response = ApiClient.getApiService().aida_framework(Config.API_KEY,
                ...
                if (apiResponse.isSuccessful()) {
                    ...
                    runOnUiThread(() -> {
                        ...
                        dialogMsg.cancel();
                        Intent intent = new Intent(AIDAFrameworkActivity.this, EditorActivity.class);
