package com.drewapps.ai.ui.templates.copywrite;
...
import com.drewapps.ai.databinding.ActivityCopyWritingBinding;
...
public class CopyWritingActivity extends AppCompatActivity {

    ActivityCopyWritingBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCopyWritingBinding.inflate(getLayoutInflater());
    ...
    private void initUI() {
        ...
        binding.etLanguage.setOnClickListener(v -> {
            Tools.ShowPopUpMenu(CopyWritingActivity.this, v, binding.etLanguage,
        ...
        binding.etName.setOnClickListener(v->{
            binding.tilName.setErrorEnabled(false);
        });
    ...
    private void startGenerating() {
        ...
        executor.execute(() -> {
            ...
            try {
                ...
                Response<Document> response = ApiClient.getApiService().copy_writing(Config.API_KEY,
                        documentName, template.templateId, MyApplication.prefManager().getInt(Constants.USER_ID),
                        name, about, language).execute();
                ...
                if (apiResponse.isSuccessful()) {
                    ...
                    runOnUiThread(() -> {
                        ...
                        dialogMsg.cancel();
                        Intent intent = new Intent(CopyWritingActivity.this, EditorActivity.class);
    ...
    private boolean validate() {
        if (binding.etDocumentName.getText().toString().isEmpty()) {
            ...
            binding.tilInstruction.setError("About Product/Service is required");
            ...
            binding.tilName.setError("Product/Service Name is required");
