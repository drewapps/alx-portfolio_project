...
import com.drewapps.ai.databinding.ActivityCancellationEmailBinding;
...
public class CancellationEmailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCancellationEmailBinding.inflate(getLayoutInflater());
    ...
    private void initUI() {
        ...
        binding.tiLanguage.setEndIconOnClickListener(v -> {
            Tools.ShowPopUpMenu(CancellationEmailActivity.this, v, binding.etLanguage,
        ...
        binding.tilOutput.setEndIconOnClickListener(v -> {
            Tools.ShowPopUpMenu(CancellationEmailActivity.this, v, binding.etOutput,
    ...
    private void startGenerating() {
        ...
        String productAbout = binding.etInstruction.getText().toString();
        ...
        executor.execute(() -> {
            ...
            try {
                ...
                Response<Document> response = ApiClient.getApiService().cancel_email(Config.API_KEY,
                        documentName, template.templateId, MyApplication.prefManager().getInt(Constants.USER_ID),
                        senderName, recName, productName, productAbout, output, language).execute();
                ...
                if (apiResponse.isSuccessful()) {
                    ...
                    runOnUiThread(() -> {
                        ...
                        dialogMsg.cancel();
                        Intent intent = new Intent(CancellationEmailActivity.this, EditorActivity.class);
