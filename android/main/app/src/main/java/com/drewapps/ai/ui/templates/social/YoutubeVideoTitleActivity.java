...
import com.drewapps.ai.databinding.ActivityYoutubeVideoTitleBinding;
...
public class YoutubeVideoTitleActivity extends AppCompatActivity {
    ...
    ActivityYoutubeVideoTitleBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityYoutubeVideoTitleBinding.inflate(getLayoutInflater());
    ...
    private void initUI() {
        ...
        binding.etOutput.setOnClickListener(v -> {
            Tools.ShowPopUpMenu(YoutubeVideoTitleActivity.this, v, binding.etOutput,
        ...
        binding.etLanguage.setOnClickListener(v -> {
            Tools.ShowPopUpMenu(YoutubeVideoTitleActivity.this, v, binding.etLanguage,
    ...
    private void startGenerating() {
        ...
        executor.execute(() -> {
            ...
            try {
                ...
                Response<Document> response = ApiClient.getApiService().youtube_video_title(Config.API_KEY,
                        documentName, template.templateId, MyApplication.prefManager().getInt(Constants.USER_ID),
                        instruction, search_term, output, emoji, language).execute();
                ...
                if (apiResponse.isSuccessful()) {
                    ...
                    runOnUiThread(() -> {
                        ...
                        dialogMsg.cancel();
                        Intent intent = new Intent(YoutubeVideoTitleActivity.this, EditorActivity.class);
    ...
    private boolean validate() {
        if (binding.etDocumentName.getText().toString().isEmpty()) {
            ...
            binding.tilInstruction.setError("Topic is required");
            binding.tilInstruction.setErrorEnabled(true);
            binding.etInstruction.requestFocus();
            return false;
        } else if (binding.etSearchTerm.getText().toString().isEmpty()) {
