...
import com.drewapps.ai.databinding.ActivityYoutubeVideoIdeasBinding;
...
public class YoutubeVideoIdeasActivity extends AppCompatActivity {

    ActivityYoutubeVideoIdeasBinding binding;
    Template template;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityYoutubeVideoIdeasBinding.inflate(getLayoutInflater());
    ...
    private void initUI() {
        ...
        binding.etOutput.setOnClickListener(v -> {
            Tools.ShowPopUpMenu(YoutubeVideoIdeasActivity.this, v, binding.etOutput,
        ...
        binding.etLanguage.setOnClickListener(v -> {
            Tools.ShowPopUpMenu(YoutubeVideoIdeasActivity.this, v, binding.etLanguage,
    ...
    private void startGenerating() {
        ...
        executor.execute(() -> {
            ...
            try {
                ...
                Response<Document> response = ApiClient.getApiService().youtube_video_idea(Config.API_KEY,
                        documentName, template.templateId, MyApplication.prefManager().getInt(Constants.USER_ID),
                        instruction,search_term, output, language).execute();
                ...
                if (apiResponse.isSuccessful()) {
                    ...
                    runOnUiThread(() -> {
                        ...
                        dialogMsg.cancel();
                        Intent intent = new Intent(YoutubeVideoIdeasActivity.this, EditorActivity.class);
    ...
    private boolean validate() {
        if (binding.etDocumentName.getText().toString().isEmpty()) {
            ...
            binding.tilInstruction.setError("Video Topic is required");
            binding.tilInstruction.setErrorEnabled(true);
            binding.etInstruction.requestFocus();
            return false;
        } else if (Integer.parseInt(binding.etSearchTerm.getText().toString()) > 100 || binding.etSearchTerm.getText().toString().isEmpty()) {
