...
import com.drewapps.ai.databinding.ActivityTitTokVideoScriptsBinding;
...
public class TitTokVideoScriptsActivity extends AppCompatActivity {

    ActivityTitTokVideoScriptsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityTitTokVideoScriptsBinding.inflate(getLayoutInflater());
    ...
    private void initUI() {
        ...
        binding.etLanguage.setOnClickListener(v -> {
            Tools.ShowPopUpMenu(TitTokVideoScriptsActivity.this, v, binding.etLanguage,
    ...
    private void startGenerating() {
        ...
        executor.execute(() -> {
            ...
            try {
                ...
                Response<Document> response = ApiClient.getApiService().tiktok_video_script(Config.API_KEY,
                ...
                if (apiResponse.isSuccessful()) {
                    ...
                    runOnUiThread(() -> {
                        ...
                        dialogMsg.cancel();
                        Intent intent = new Intent(TitTokVideoScriptsActivity.this, EditorActivity.class);
