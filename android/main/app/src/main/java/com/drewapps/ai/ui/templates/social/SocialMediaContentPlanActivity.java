...
import com.drewapps.ai.databinding.ActivitySocialMediaContentPlanBinding;
...
public class SocialMediaContentPlanActivity extends AppCompatActivity {

    ActivitySocialMediaContentPlanBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivitySocialMediaContentPlanBinding.inflate(getLayoutInflater());
    ...
    private void initUI() {
        ...
        binding.etOutput.setOnClickListener(v -> {
            Tools.ShowPopUpMenu(SocialMediaContentPlanActivity.this, v, binding.etOutput,
        ...
        binding.tiPlatform.setEndIconOnClickListener(v -> {
            Tools.ShowPopUpMenu(SocialMediaContentPlanActivity.this, v, binding.etPlatform,
    ...
    private void startGenerating() {
        ...
        executor.execute(() -> {
            ...
            try {
                ...
                Response<Document> response = ApiClient.getApiService().social_media_content_plan(Config.API_KEY,
                        documentName, template.templateId, MyApplication.prefManager().getInt(Constants.USER_ID),
                        instruction, output, platform,
                        emoji).execute();
                ...
                if (apiResponse.isSuccessful()) {
                    ...
                    runOnUiThread(() -> {
                        ...
                        dialogMsg.cancel();
                        Intent intent = new Intent(SocialMediaContentPlanActivity.this, EditorActivity.class);
    ...
    private boolean validate() {
        if (binding.etDocumentName.getText().toString().isEmpty()) {
            ...
            binding.tilInstruction.setError("Objective is required");
