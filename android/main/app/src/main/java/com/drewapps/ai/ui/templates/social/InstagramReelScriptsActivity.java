...
import com.drewapps.ai.databinding.ActivityInstagramReelScriptsBinding;
...
public class InstagramReelScriptsActivity extends AppCompatActivity {
    ...
    ActivityInstagramReelScriptsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityInstagramReelScriptsBinding.inflate(getLayoutInflater());
    ...
    private void initUI() {
        ...
        binding.etLanguage.setOnClickListener(v -> {
            Tools.ShowPopUpMenu(InstagramReelScriptsActivity.this, v, binding.etLanguage,
    ...
    private void startGenerating() {
        ...
        executor.execute(() -> {
            ...
            try {
                ...
                Response<Document> response = ApiClient.getApiService().instagram_reel_script(Config.API_KEY,
                ...
                if (apiResponse.isSuccessful()) {
                    ...
                    runOnUiThread(() -> {
                        ...
                        dialogMsg.cancel();
                        Intent intent = new Intent(InstagramReelScriptsActivity.this, EditorActivity.class);
