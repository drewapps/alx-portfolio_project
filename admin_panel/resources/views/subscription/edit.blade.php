                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {!! Form::number('total_words', $subscription->total_words,['class' => 'form-control','required','placeholder'=>'Enter Total Words']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {!! Form::number('number_of_images',$subscription->number_of_images,['class' => 'form-control','required','placeholder'=>'Enter Number of Images']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select id="plan_type" name="plan_type" class="form-control" required>
                                        ...
                                        <option value="yearly" @if($subscription->plan_type == 'yearly') selected @endif>Yearly</option>
                                        <option value="trial" @if($subscription->plan_type == 'trial') selected @endif>Trial</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="description" id="desc_text" class="form-control" required>{{$subscription->description}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9"><input class="form-control" type="file" id="image" name="image" onchange="imagePreview()" accept=".jpg, .png, jpeg, .PNG, .JPG, .JPEG"></div>
                            </div>
                            <div class="row">
                                <div class="col-sm-3"></div>
                                <div class="col-sm-9" id="preview">
                                    <img type="image" class="shadow bg-white rounded" src="{{asset('uploads/'.$subscription->image)}}" alt="Image" style="width: auto;height: 150px" />
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php $i=0; ?>
                    @if($include_plan_detail != null)
                    <?php $i=1; ?>
                    @foreach($include_plan_detail as $value)
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <?php $i=0; ?>
                    @if($not_include_plan_detail != null)
                    <?php $i=1; ?>
                    @foreach($not_include_plan_detail as $value)
                    <div class="row mb-2"><div class="col-11"><input type="text" class="form-control" name="detail1[{{$i}}]" value="{{$value}}" placeholder="Enter Detail"></div><div class="col-1"><button type="button" class="btn btn-danger remove1"><i class="fa fa-xmark"></i></button></div></div>
                    <?php $i++;?>
                    @endforeach
                    @endif
                    <input type="hidden" id="countId1" value="{{$i}}">
