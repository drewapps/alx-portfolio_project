                        ...
                        <div class="col-12 col-md-8 col-lg-6">
                            <div class="p-4 text-center">
                                ...
                                <div class="form-outline mb-3">
                                    <input type="email" class="form-control form-control-lg" style="font-size:20px;" placeholder="EMAIL" id="email" name="email" value="{{ old('email') }}" autofocus required>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 form-check mt-3 text-right" style="padding-right:0px;">
                                        <a href="{{ route('password.request') }}" target="_blank" class="text-primary" style="font-size:20px;"><b>Forgot Password?</b></a>
                                    </div>
                                </div>
                ...
                <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                    <div class="card shadow-2-strong shadow shadow-lg" style="border-radius: 5px;">
                        <div class="card-body p-4 text-center">
                            ...
                            <h3 class="mt-4 mb-1" style="color:#f77b0b">Welcome To {{App\Models\Setting::getSetting('app_name')}}</h3>
