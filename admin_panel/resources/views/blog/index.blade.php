        ...
        <table class="table" id="data_table">
          ...
          @foreach($data as $row)
            <tr>
              ...
              <td><img src="{{asset('uploads/'.$row->image)}}" style="height:50px;width:auto;display: inline;"><b class="ml-3" style="font-size:16px;">{{$row->title}}</b></td>
              ...
              <td class="align-middle">
                <div class="btn-group text-center">
                    <a href="{{url('admin/blog/'.$row->id.'/edit') }}"><button type="button" class="btn btn-success"><span aria-hidden="true" class="fa fa-edit"></span></button></a>
                ...
                {!! Form::open(['url' => 'admin/blog/'.$row->id,'method'=>'DELETE','class'=>'form-horizontal','id'=>'form_'.$row->id]) !!}
